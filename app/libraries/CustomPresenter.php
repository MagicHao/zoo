...
class CustomerPresenter {
    ...
    public function getPageRange($start, $end)
    {
        ...
        for ($page = $start; $page <= $end; $page++)
        {
            ...
            {
                $pages[] = '<a class="ui-pagination-item ui-pagination-active"><span>'.$page.'</span></a>';
            }
            else
            {
    ...
    public function getPrevious($text = '&laquo;')
    {
        ...
        {
            return '<a class="ui-pagination-item ui-pagination-disabled"><span>'.$text.'</span></a>';
        }
        else
        {
            $url = $this->paginator->getUrl($this->currentPage - 1);

            return '<a class="ui-pagination-item" href="'.$url.'">'.$text.'</a>';
        }
    }
    ...
    public function getNext($text = '&raquo;')
    {
        ...
        {
            return '<a class="ui-pagination-item disabled"><span>'.$text.'</span></a>';
        }
        else
        {
            $url = $this->paginator->getUrl($this->currentPage + 1);
    ...
    public function getLink($page)
    {
        ...
        return '<a class="ui-pagination-item" href="'.$url.'">'.$page.'</a>';
    }
